...
public class WallProgressionLevel3 : MonoBehaviour {

    public ButtonMngrLevel3 ButtonMan;
    ...
    private void OnCollisionEnter(Collision collision)
    {
        if (collision.gameObject.tag == "Player")
        {
            ...
            {
                GameUI.Level3Complete = 1;
                PlayerPrefs.SetFloat("Level3Complete", GameUI.Level3Complete);
